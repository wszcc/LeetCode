...
import { EmptyUsername, EmptyPassword } from '../ErrorInfo/errorInfo'
import {
    beEmptyPwd,
    beEmptyUername,
    beInvalid,
...
interface IMapDispatch {
    ...
    beInvalid: () => void;
    notBeEmptyPwd: () => void;
    notBeEmptyUsername: () => void;
    notBeInvalid: () => void;
    breakPwdDefault: () => void;
    breakUsernameDefault: () => void;
    keepPwdDefault: () => void;
    keepUsernameDefault: () => void;
